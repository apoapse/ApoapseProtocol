...
SecurityLog::SecurityAlert SecurityLog::GetAlertFromErrorCode(ApoapseErrorCode errorCode)
{
	static const std::vector<SecurityAlert> errors
	{
		...
		{ ApoapseErrorCode::unable_to_authenticate_user, SecurityAlert::Severity::minor, "Unable to authenticate the user", SecurityAlert::AdditionalAction::notify_sender },
	};
